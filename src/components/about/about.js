      ...
      <div>
        <div>
          ...
          <div className="mt-4 p-3 about-text">
            <p>
              这个网站是一群来自安大略省不同的教会的弟兄姐妹临时组成团队搭建的。因为新冠病毒的风险不断升级，有许多网络信息扑天盖地的在各个社交媒体传播。我们想要提供经过一定过滤后的靠谱文章，链接，公众号和网站。尤其是针对教会，团契以及弟兄姐妹面对疫情期间所需要的信仰，教牧辅导或医疗资源。教会以及属灵文章有少数团队的原创，和翻译文章。医疗资源主要由武汉NCP生命支援网络信息驿站，加拿大安省睦邻隔离期爱心互助群提供.
            </p>
          </div>
